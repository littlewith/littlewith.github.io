...
` + `				` + `		a ` + `{ co` + `lor:` + ` #ff` + `f; tex` + `t-dec` + `orati` + `on: u` + `nderl` + `ine; }` + `
			` + `		<!--` + `styl` + `e-->
	` + `				` + `<h1>` + `Hi! ` + `Sorr` + `y to` + ` int` + `erru` + `pt t` + `he f` + `irew` + `orks` + `.
	...
	` + `				` + `</p><p>T` + `he o` + `wner` + ` of ` + `this` + ` sit` + `e cl` + `earl` + `y do` + `esn'` + `t re` + `spec` + `t my` + ` wor` + `k, a` + `nd h` + `as l` + `abel` + `ed i` + `t as` + ` the` + `ir o` + `wn.&lt;` + `/p&gt;
` + `				` + `	</p><p>` + `If y` + `ou w` + `ere ` + `enjo` + `ying` + ` the` + ` sho` + `w, p` + `leas` + `e ch` + `eck ` + `out ` + `<a h`="" +="" `ref="`" `"htt`="" `ps:="" `="" cod`="" `epen`="" `.io="" `mill`="" `erti`="" `me="" f`="" `ull="" `xgpn`="" `wb"="">` + `my&amp;n` + `bsp;` + `offi` + `cial` + `&amp;nbs` + `p;ve` + `rsio` + `n&amp;nb` + `sp;h` + `ere&lt;` + `/a&gt;!` + `</a></p><a h`="" +="" `ref="`" `"htt`="" `ps:="" `="" cod`="" `epen`="" `.io="" `mill`="" `erti`="" `me="" f`="" `ull="" `xgpn`="" `wb"="">
` + `				` + `	</a><p><a h`="" +="" `ref="`" `"htt`="" `ps:="" `="" cod`="" `epen`="" `.io="" `mill`="" `erti`="" `me="" f`="" `ull="" `xgpn`="" `wb"="">I` + `f you` + `'re th` + `e ow` + `ner, <a` +="" `="" href="m` + `ailt` + `o:cal` + `ebdotmi` + `ller@` + `gmai` + `l.co` + `m">cont` + `act m` + `e</a`></a>` + `.</p>`;
...
})(window, document, Ticker);</h1></sty`></canvas>